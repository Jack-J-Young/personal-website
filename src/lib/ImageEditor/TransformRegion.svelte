...
<svg>
    {#if lines.length == 4}
        ...
        <line x1={0} y1={0} x2={points[0].x} y2={points[0].y} stroke="var(--marker)" />
        <line x1={imgWidth} y1={0} x2={points[1].x} y2={points[1].y} stroke="var(--marker)" />
        <line x1={imgWidth} y1={imgHeight} x2={points[2].x} y2={points[2].y} stroke="var(--marker)" />
        <line x1={0} y1={imgHeight} x2={points[3].x} y2={points[3].y} stroke="var(--marker)" />
    {/if}
    {#each lines as line}
        {#if line}
            <line x1={line.x1} y1={line.y1} x2={line.x2} y2={line.y2} stroke="var(--marker)" />
        {/if}
    {/each}
</svg>
